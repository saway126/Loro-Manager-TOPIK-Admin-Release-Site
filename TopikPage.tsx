...
export default function TopikPage({ isDarkMode, setDarkMode }: DetailPageProps) {
    const c = content[Language.KO].topikPage;
    ...
    const mobileUrls = releaseData?.apps.topik.mobile;
